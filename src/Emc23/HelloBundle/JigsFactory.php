...
class JigsFactory
{
    ...
    function generateGroup($faction)
    {
        ...
        $query      = $this->em->createQuery('SELECT a FROM Emc23HelloBundle:J17Usergroups a WHERE a.parentId =' . $faction);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    
    {
        ...
        if ($owner->type == "N")
        {
            $query      = $em->createQuery('SELECT a FROM Emc23HelloBundle:J17JigsCharacters a WHERE a.gid =' . $Gid);
        ...
        elseif ($owner->type == "P")
        {
            $query      = $em->createQuery('SELECT a FROM Emc23HelloBundle:J17UserUsergroupMap a WHERE a.groupId =' . $Gid);
