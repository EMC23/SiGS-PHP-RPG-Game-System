...
namespace Emc23\HelloBundle\Controller;
        use Symfony\Bundle\FrameworkBundle\Controller\Controller;
        use Emc23\HelloBundle\Entity\J17JigsAwards;
        use Symfony\Component\HttpFoundation\Response;
        use Emc23\HelloBundle\Model\Jigs;
        use Emc23\HelloBundle\Entity\J17JigsCharacters;
        use Emc23\HelloBundle\Entity\J17JigsPlayers;
        use Emc23\HelloBundle\Entity\J17JigsBuildings;
        ...
        //use Emc23\HelloBundle\Entity\J17JigsFactions;
     //   use Emc23\HelloBundle\Entity\J17JUsergroups;
...
class DefaultController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('Emc23HelloBundle:Default:index.html.twig', array('name' => $name));
    }
...
//$record = $form->getData();
        ...
        return $this->render("Emc23HelloBundle:Default:" . $type . "_page.html.twig", array('form' => $form->createView(), 'type' => $type));
    ...
    public function showAction($id, $type, Request $request)
    {
        ...
        $record = $this->getDoctrine()
            ...
            ->getRepository("Emc23HelloBundle:$type")
            ->find($id);
...
//   $task = new $type();
        ...
        return $this->render("Emc23HelloBundle:Default:" . $type . "_page.html.twig", array('stuff' => $record, 'form' => $form->createView(), 'type' => $type));
    ...
    public function showfactionsAction()
    {
        ...
        foreach ($gids as $gid) {
            ...
            $query = $em->createQuery(
                ' SELECT p,a FROM Emc23HelloBundle:J17Usergroups a  LEFT JOIN a.gid p WHERE a.parentId =' . $gid);
...
// return $this->render('AcmeHelloBundle:Default:layout.html.php');
        return $this->render('Emc23HelloBundle:Default:layout.html.php', array('pagination' => $this->faction));
...
/////////////////////////////////          
            ...
            public function showallusersAction()
            {
                ...
                $query = $em->createQuery(
                    'SELECT p
            FROM Emc23HelloBundle:J17JigsPlayers p
            WHERE p.id > :id
            ORDER BY p.iduser ASC'
                ...
                foreach ($products as $record) {
                    ...
                    $content .= $this->renderView(
                        'Emc23HelloBundle:Hello:index.html.twig',
...
/////////////////////////////////
            ...
            {
                $em = $this->getDoctrine()->getManager();
                $query = $em->createQuery('SELECT p FROM Emc23HelloBundle:J17Comprofiler p WHERE p.id > 1 ORDER BY p.id ASC');
            ...
            public function listAction($type)
            {
                ...
                $dql = "SELECT a FROM Emc23HelloBundle:$type a";
                ...
                //  echo '</pre>';
                // parameters to template
                return $this->render('Emc23HelloBundle:Default:' . $type . '.html.twig', array('pagination' => $pagination, 'type' => $type));
            }
        }
